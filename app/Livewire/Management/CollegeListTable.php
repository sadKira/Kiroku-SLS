...
#[Lazy]
class CollegeListTable extends Component
{
    use WithPagination;
    ...
    public function updateProfileInformation(): void
    {
        try {
            ...
            if ($e->getCode() == 23000) {
                $this->dispatch('notify',
                    type: 'error',
                    content: 'Unable to update student. A duplicate may exist.',
                    duration: 5000
                );
            } else {
                $this->dispatch('notify',
    ...
    {
        return view('livewire.management.college-list-table-placeholder');
    }

    public function render()
    {
        $query = Student::college()
        ...
        return view('livewire.management.college-list-table', [
            'students' => $query->paginate(10),
            'hasStudents' => Student::college()->exists(),
            'courses' => $courses,
        ]);
    }
}
